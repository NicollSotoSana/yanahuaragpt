...
<input type="text" name="motivo" value="Error de redaccion" class="form-control">
<div class="text-right">
	<button data-confirm="Una vez realizada la devolución no podra volverlo hacer, por eso verifique bien la cantidad a devolver. ¿Desea continuar?" type="submit" id="btnDevolucionGuardar" class="btn btn-primary submit-ajax-button"><i class="glyphicon glyphicon-refresh"></i> Guardar</button>
</div>
<?php echo form_close(); ?>
