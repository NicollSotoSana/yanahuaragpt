						...
						<div class="form-group">
							...
							<select id="sltReporte" class="form-control">
								...
								<optgroup label="Movimiento de su Negocio">
									...
									<option value="7">Top de Colaboradores</option>
								...
								<!--<optgroup label="Reporte de Comprobantes">
									<option value="9">Comprobantes por Fecha</option>
								</optgroup>-->
							</select>
						</div>					
					</div>
...
<script>
	function getReporte(){
		...
		var fin = $("#dfin").val();
		window.open('<?php echo base_url();?>reportes/reporteDias/'+inicio+'/'+fin, '_blank');
	}
</script>