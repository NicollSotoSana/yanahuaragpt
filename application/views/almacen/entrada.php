	...
	<div class="col-md-12">
		...
		<?php echo form_open('almacen/' . ($this->router->method == 'entrada' ? 'entradacrud' : 'ajustarcrud')  , array('class' => 'upd')); ?>
          ...
          <div class="form-group">
            ...
            <input id="proveedor_nombre" autocomplete="off" name="proveedor_nombre" type="text" class="form-control" placeholder="Nombre Proveedor"/>
            <input id="proveedor_id" autocomplete="off" name="proveedor_id" type="hidden" class="form-control" placeholder="Nombre Proveedor" value=""/>
          </div>
          <div class="form-group">
            <label>Guía/Factura</label>
            <input id="guia_factura" autocomplete="off" name="guia_factura" type="text" class="form-control" placeholder="Nro. de Factura o Guía de Remision"/>
          </div>
		  <div class="form-group">
