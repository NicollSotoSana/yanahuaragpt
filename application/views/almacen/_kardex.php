<?php
	...
	$tSalida  = 0;
?>
<table class="table report" id="Exportar_a_Excel">
	<thead>
		<tr>
			<th class="bg-none"></th>
		...
		<tr class="sub-legend">
			...
			<th style="width:100px;" class="text-right">Comprobante</th>
	...
	<?php foreach($kardex as $k): ?>
		<tr>
			...
			<td class="text-right">
				...
				if($k->Tipo == 2){
				?>
					<a href="<?php echo base_url("ventas/comprobante/".$k->Comprobante_id.""); ?>" target="_blank">Ver Comprobante</a>
				<?php }?>
			</td>
			<td class="text-right">
				<?php if($k->Tipo == 1): ?>
