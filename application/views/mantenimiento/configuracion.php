				  ...
				  <div class="tab-pane active" id="cempresa" style="padding-top:15px;">
					<?php echo form_open('mantenimiento/configuracionactualizar', array('class' => 'upd')); ?>
					  ...
					  <div class="form-group">
					   ...
					   <input type="text" value="<?php echo $this->conf->cuenta_soles; ?>" class="form-control" name="cuenta_soles"/>
					  </div>
					  <div class="form-group">
					    <label>Cuenta Dólares</label>
					    <input type="text" value="<?php echo $this->conf->cuenta_dolares; ?>" class="form-control" name="cuenta_dolares"/>
					  </div>
					  <div class="form-group" style="display:none;">
					    <label>Tipo Cambio</label>
					    <input type="text" value="<?php echo $this->conf->tipo_cambio; ?>" class="form-control" name="tipo_cambio"/>
					  </div>
					  <div class="form-group" style="display:none;">
					    <label>Porcentaje de Detracción</label>
					    <input type="text" value="<?php echo $this->conf->porcentaje_detraccion; ?>" class="form-control" name="porcentaje_detraccion"/>
					  </div>
