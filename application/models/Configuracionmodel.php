...
class configuracionmodel extends CI_Model
{
	...
	public function GuardarConfiguracionImpresora($formato, $tipo)
	{
		...
		if($tipo == 6) $conf['OrdenFormato'] = str_replace(' background: none repeat scroll 0% 0% transparent;', '', $formato);
		if($tipo == 7) $conf['ProformaFormato'] = str_replace(' background: none repeat scroll 0% 0% transparent;', '', $formato);	
